...
[![CI Python PYTEST](https://github.com/luizamonroe/Seminario-S206-PYTEST/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/luizamonroe/Seminario-S206-PYTEST/actions/workflows/CI.yml)
...
- [Instalação](#instalação-das-ferramentas-necessárias-%EF%B8%8F)
   ...
   - [Linux](#-linux-so)
   - [MacOS](#-macos)
- [Vantagens do Pytest](#vantagens-do-pytest)
